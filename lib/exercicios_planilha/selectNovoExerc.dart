...
class NovoExercicioSel extends StatefulWidget {
  final String authId;
  ...
  NovoExercicioSel(this.addMode, this.set, this.treinoId, this.exeId,
      this.qntdExe, this.authId, this.title, this.padding);
  @override
  _NovoExercicioSelState createState() => _NovoExercicioSelState(
      addMode, set, treinoId, exeId, qntdExe, authId, title, padding);
}

class _NovoExercicioSelState extends State<NovoExercicioSel> {
  final String authId;
  final bool addMode;
  final int set;
  final String treinoId;
  ...
  final String title;
  final double padding;
  _NovoExercicioSelState(this.addMode, this.set, this.treinoId, this.exeId,
      this.qntdExe, this.authId, this.title, this.padding);
                        ...
                        itemBuilder: (context, index) {
                          return Column(
                            children: [
                              ...
                              GestureDetector(
                                onLongPress: () async {
                                  if (_isInterstitialAdReady && adClick >= 3) {
                                ...
                                onTap: () async {
                                  ...
                                  //     settings: RouteSettings(name: "/adicionar"),
