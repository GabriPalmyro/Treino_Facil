...
class TreinoScreen extends StatefulWidget {
  ...
  final String title;
  TreinoScreen(this.title, this.treinoId, this.authId);

  @override
  _TreinoScreenState createState() =>
      _TreinoScreenState(title, treinoId, authId);
}
...
class _TreinoScreenState extends State<TreinoScreen> {
  ...
  final String title;
  bool payApp = false;
  _TreinoScreenState(this.title, this.treinoId, this.authId);
          ...
          IconButton(
              ...
              onPressed: () {
                Navigator.of(context).pushReplacement(MaterialPageRoute(
                    builder: (context) =>
                        TreinoScreen(title, treinoId, authId)));
              }),
          IconButton(
            icon: Icon(
              Icons.delete,
