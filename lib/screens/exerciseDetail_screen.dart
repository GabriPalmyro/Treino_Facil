...
class ExerciseDetail extends StatefulWidget {
  ...
  ExerciseDetail(this.exercise, this.set, this.addMode, this.qntdExe,
      this.treinoId, this.exeId, this.authId, this.titleId);

  @override
  _ExerciseDetailState createState() => _ExerciseDetailState(
      exercise, set, addMode, qntdExe, treinoId, exeId, authId, titleId);
}
                ...
                onPressed: () {
                  Navigator.of(context).pushReplacement(MaterialPageRoute(
                      builder: (context) => MuscleListScreen(addMode, set,
                          treinoId, idExe, qntdExe, authId, titleId)));
                },
              )
            ],
          );
              ...
              child: InkWell(
                onTap: () {
                  if (_formKey.currentState.validate()) {
                    ...
                    if (_isInterstitialAdReady && !_isInterstitialAdShow) {
